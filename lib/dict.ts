...
const dictNL = {
  ...
  contactPage: {
    ...
    directMail: {
      eyebrow: "Het meest direct",
      titleA: "Stuur ons een",
      titleAccent: "mail.",
      body: "Vertel kort over uw merk, de gelegenheid en het gewenste aantal gasten. Wij komen binnen 24 uur terug — met een eerste reactie en, indien passend, een conceptvoorstel binnen 5 werkdagen.",
      ctaLabel: "info@culinair-annonu.com",
      phoneLabel: "Liever bellen?",
    },
...
const dictEN: typeof dictNL = {
  ...
  contactPage: {
    ...
    directMail: {
      ...
      titleA: "Send us an",
      titleAccent: "email.",
      body: "Tell us briefly about your brand, the occasion and the expected guest count. We get back within 24 hours — with a first response and, where appropriate, a concept proposal within 5 working days.",
      ctaLabel: "info@culinair-annonu.com",
