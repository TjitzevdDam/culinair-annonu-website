...
const dictNL = {
  ...
  aboutPage: {
    ...
    person: {
      ...
      body1: "Tjitze van der Dam is oprichter en culinair regisseur van Culinair AnnoNu. Met 25+ jaar ervaring in de top van de Nederlandse gastronomie organiseerde hij events voor duizenden gasten — voor onder andere Penfolds, Gault & Millau, DPG Media, Gall & Gall en Landgoed de Salentein.",
